...
var rangeGrp = document.querySelector(".range"); // const bookingForm = document.querySelector('#reservation-form');

var searchBar = document.querySelector("#search-bookings-form");
var searchBarTwo = document.querySelector("#search-bookings-form-two");
...
if (searchBarTwo) {
  searchBarTwo.addEventListener("submit", function (e) {
    e.preventDefault();
    var searchParam = document.querySelector('input[name="search-input-two"]').value;
    var input = searchParam; // return;
...
var searchByClientname = function searchByClientname(input) {
  try {
    showAlert("success", "Redirecting...");
    location.assign("/bookings?clientName=".concat(input));
  } catch (error) {
    showAlert("error", "Invalid input!");
  }
};
